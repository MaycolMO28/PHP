                ...
                <div class="card-body px-lg-5 pt-0">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <div class="md-form">
                                <input name="nombre_registro" type="text" id="materialRegisterFormFirstName" class="form-control">
                        ...
                        <div class="col">
                            ...
                            <div class="md-form">
                                <input name="apellido_registro" type="text" id="materialRegisterFormLastName" class="form-control">
                    ...
                    <div class="md-form">
                        <input name="contraseña_registro" type="password" id="materialRegisterFormPassword" class="form-control" aria-describedby="materialRegisterFormPasswordHelpBlock">
                 ...
                 <div class="form-row">
                    <div class="col">
                        ...
                        <div class="md-form">
                          ...
                          <input name="date_usuario" type="date" value="" id="materialRegisterFormFirstName" class="form-control" >
                  ...
                  <div class="col">
                    ...
                    <div class="md-form">
                       <select class="browser-default custom-select mb-4" name="sexo">
